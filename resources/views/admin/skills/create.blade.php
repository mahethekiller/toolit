                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                               value="{{ old('name') }}" required placeholder="e.g., PHP, Laravel, JavaScript">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="range" class="form-range" id="level" name="level"
                               min="0" max="100" value="{{ old('level', 50) }}"
                               oninput="updateLevelValue(this.value)">
                        <div class="d-flex justify-content-between">
                            <small>0%</small>
                            <span id="levelValue" class="fw-bold">{{ old('level', 50) }}%</span>
                            <small>100%</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="type" name="type"
                               value="{{ old('type') }}" placeholder="e.g., Backend, Frontend, Database">
