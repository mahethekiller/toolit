...
<head>
    ...
    <title>{{ $title ?? 'Online Tools' }} | ToolSite</title>

    <!-- Meta for SEO -->
    <meta name="description" content="{{ $metaDescription ?? 'Free online tools to simplify your work.' }}">
    <meta name="keywords" content="{{ $metaKeywords ?? 'tools, online converter, text tools, case converter' }}">
    <meta name="author" content="ToolSite">
