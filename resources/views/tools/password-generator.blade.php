        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4">
                    <h2 class="fw-bold mb-3 text-center">🔐 Password Generator</h2>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="length" type="range" class="form-range" min="8" max="64" step="1" value="16">
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="noAmbiguous">Exclude ambiguous characters (O/0, l/1, I)</label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <div class="input-group mb-3">
                        <input id="passwordOutput" type="text" class="form-control form-control-lg" placeholder="Click Generate…" readonly>
                        <button id="copyBtn" class="btn btn-outline-secondary" type="button" disabled>📋 Copy</button>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="listOutput" class="form-control" rows="7" readonly placeholder="Your generated passwords will appear here, one per line."></textarea>
                    </div>
                </div>
            </div>
        </div>
...
function generatePassword(opts) {
    const sets = [];
    const { lower, upper, number, symbol } = charsets(opts.noAmbiguous);
...
function estimateStrength(length, opts) {
    ...
    if (pool === 0) return { pct: 0, label: 'Select at least one set' };
...
function updateStrength() {
    ...
    const { pct, label } = estimateStrength(opts.length, opts);
